...
async function main() {
    ...
    const post = await prisma.post.upsert({
        ...
        update: {
            ...
            excerpt: 'Hyperlocal delivery didn\'t just need more riders. It needed a smarter, more structured model. Here\'s how QWQER Express responded to the growing demand for organized within-city delivery.',
            content: blogContent,
            image: '/blog/1.webp',
            readTime: '8 min read',
            date: 'March 5, 2026',
