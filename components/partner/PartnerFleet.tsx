      ...
      <div className="relative z-10 max-w-[1300px] mx-auto px-6 md:px-14 lg:px-20">
        ...
        <div className="pf-badge mb-4 flex justify-center" style={{ opacity: 0 }}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill={A}><path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zm-1 1l1.96 2.5H17V9h2zm-11 9c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm2.22-3c-.55-.61-1.33-1-2.22-1s-1.67.39-2.22 1H3V6h12v9H10.22zM18.5 17c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/></svg>
        ...
        <h2 className="pf-title text-center text-3xl md:text-5xl font-extrabold tracking-tight mb-4" style={{ opacity: 0 }}>
          QWQER Fleet <span style={{ color: A }}>for Fleet Owners</span>
        </h2>
        ...
        <div className="pf-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          {FLEET_FEATURES.map((f, i) => (
            ...
            >
              ...
              {/* Top accent */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0 group-hover:w-10 h-[2px] rounded-full transition-all duration-500" style={{ background: A }} />
