      ...
      <div className="relative z-10 max-w-[800px] mx-auto px-6 md:px-14">
        <div className="pcta-content text-center" style={{ opacity: 0 }}>
          ...
          <div className="relative inline-flex items-center justify-center mb-8">
            <div className="pcta-ring absolute w-20 h-20 rounded-full" style={{ border: "2px solid #7c3aed", opacity: 0.4 }} />
            <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: "linear-gradient(135deg, #7c3aed, #6d2ed4)" }}>
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-5">
            Ready to get started as <span style={{ color: "#7c3aed" }}>QWQER rider?</span>
          </h2>
          <p className="text-white/70 text-sm md:text-base leading-relaxed max-w-md mx-auto mb-10">
          ...
          {/* Trust line */}
          <p className="mt-8 text-[12px] text-white/70 tracking-wide">
