...
const industries = [
    ...
    { name: "Fish & Meat", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4", desc: "Where freshness is non-negotiable, we ensure perishable orders are picked up and delivered with the urgency they demand." },
