...
export default function Services() {
    ...
    return (
        <section ref={sectionRef} className="py-10 pb-32 bg-black relative">
            {/* Vertical Path Line (Simulated for this section) */}
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-1 h-32 bg-[#ee3425]"></div>

            {/* Line splits into two (Visual only using borders/pseudo elements or SVG path) */}
            <div className="absolute top-32 left-1/2 transform -translate-x-1/2 w-[80%] h-20 border-t-4 border-l-4 border-r-4 border-[#ee3425]/20 rounded-t-[3rem] hidden md:block"></div>
