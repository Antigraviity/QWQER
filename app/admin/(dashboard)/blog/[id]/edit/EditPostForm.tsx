...
import { updatePost } from '@/lib/data-actions';
        ...
        <main className="max-w-4xl mx-auto">
            ...
            <form action={dispatch} className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm space-y-6">
                ...
                <div>
                    ...
                    <input id="slug" name="slug" type="text" ref={slugRef} placeholder="enter-post-slug" required
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="readTime" name="readTime" type="text" placeholder="e.g. 5 min read"
