...
import { updatePrPost } from '@/lib/data-actions';
...
export default function EditPrPostForm({ post }: { post: PostData }) {
    const initialState: State = { message: null, errors: {} };
    const updateWithId = updatePrPost.bind(null, post.id);
    ...
    return (
        <main className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-2xl font-bold text-gray-900">Edit PR Post</h1>
